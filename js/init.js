jQuery(document).ready(function () {
  ...
  function foliox_tm_modalbox() {
    "use strict";
    jQuery(".foliox_tm_all_wrap").prepend(
      '<div class="foliox_tm_modalbox"><div class="box_inner"><div class="close"><a href="#"><i class="icon-cancel"></i></a></div><div class="description_wrap"></div></div></div>'
    );
  }
  ...
  function foliox_tm_modalbox_news() {
    ...
    button.on("click", function () {
      ...
      modalBox
        ...
        .after(
          '<div class="details"><div class="meta">' + meta + '</div><div class="title"><h3>' + title + "</h3></div><div>"
        );
      foliox_tm_data_images();
      return false;
    });
  ...
  function foliox_tm_owl_carousel() {
    ...
    carousel2.owlCarousel({
      ...
      nav: false,
      navSpeed: true,
      responsive: { 0: { items: 2 }, 480: { items: 3 }, 768: { items: 3 }, 1300: { items: 5 } },
    });
  }
  ...
  function foliox_tm_down() {
    ...
    jQuery(".anchor").on("click", function () {
      if ($.attr(this, "href") !== "#") {
        $("html, body").animate({ scrollTop: $($.attr(this, "href")).offset().top - topbar - 50 }, 800);
      }
      return false;
    });
  }
  new WOW().init();
  jQuery(".tilt-effect").tilt({ maxTilt: 4, easing: "cubic-bezier(.03,.98,.52,.99)", speed: 500, transition: true });