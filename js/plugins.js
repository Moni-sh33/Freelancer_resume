    ...
    OnePageNav.prototype = {
      ...
      scrollTo: function (target, callback) {
        ...
        if (ww >= 1040) {
          ...
          $("html, body").animate({ scrollTop: offset - 100 }, this.config.scrollSpeed, this.config.easing, callback);
        }
      },
    ...
    var y = !1,
      ...
      L = (function () {
        ...
        return 0 < e.split("https://marketifythemes.net/").length
          ? e.split("https://marketifythemes.net/").slice(0, -1).join("https://marketifythemes.net/") + "/"
          : "";
      })();
      ...
      T = function (n) {
        return (
          (n === a && t.currTemplate.closeBtn) ||
            ((t.currTemplate.closeBtn = e(t.st.closeMarkup.replace("%title%", t.st.tClose))), (a = n)),
        ...
        getInline: function (n, i) {
          if ((M(), n.src)) {
            ...
            if (r.length) {
              ...
              a &&
                a.tagName &&
                (E || ((S = o.hiddenClass), (E = x(S)), (S = "mfp-" + S)), (z = r.after(E).detach().removeClass(S))),
